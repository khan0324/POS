...
<div class="wrapper" >
        ...
        <div class="neworder">
            ...
            <div style="margin-top: 5px;margin-right: 20px; float: right;max-width: 40%;">
                ...
                <button type="submit" id="SaveButton" class="btn-primary btn" onclick="callurl();" style="margin-bottom: 10px"> Save </button>
                 <button type="submit" id="SaveButtons" class="btn-primary btn"  style="margin-bottom: 10px; display: none"> Save </button>
        </div>
        </div>
...
<script type="text/javascript">
  ...
  var TotalItems = 0; //DECLARATION OF TOTAL ORDERD ITEMS
    ...
    ajax.onreadystatechange = function display()
    {
        if(this.readyState == 4 && this.status == 200)
        {
            ...
            for (var i = 0; i<data.length ; i++)
            {
                ...
                var status = data[i].invoiceno;
                var right = "<?php echo $status?>";
            ...
            if (status != 111 || status != '111' || right == "Admin" || right == "Super"){
    ...
    $(document).ready(function()
    {
        $("#SaveButtons").click(function Order()//Function to Select Product And Quantity
            {
