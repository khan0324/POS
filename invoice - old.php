    ...
    ajax.onreadystatechange = function display()
    {
        if(this.readyState == 4 && this.status == 200)
        {
            ...
            for (var i = 0; i<data.length ; i++)
            {
                ...
                Row +="<td>"+status+"</td>";
                Row +="<td>"+invoiceno+"</td>";
                Row +="<td><a href='#' onclick='view("+invoiceno+")' class='btn-warning ' style='font-size:22px;' >View</a>/<a style='font-size:22px;' href='#' class=' update btn-dark' name='"+tableno+"'  id='"+invoiceno+"'>Edit</a><span class='HideInTab printhide'>/</span><a style='font-size:22px;' class='btn-info printhide' href='#' onclick='callurl(\""+sr+"\",\""+tableno+"\",\""+invoiceno+"\")'>Print</a></td>";
