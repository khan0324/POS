...
<div class="wrapper" style="color: white">
	...
	<div class="Top" style="text-align: center;width: 100%"><!-- Top Class Contains Customer info and all things regarding company like Logo, phone no and address -->
		<div class="Nameon companydetail" style="display: inline-block; margin: 10px 0px 0px 0px;"><h1 style="font-size:50px; font-family: Georgia, serif; text-decoration: underline; text-decoration-color: chocolate; text-align: center; ">CHAI JUNCTION</h1>
...
<h4 class="T" >PAYMENT RECEIPT</h4>
	...
	<div class="receiptdetail" style="width: 100%; height: 350px; border: 1px solid">
		...
		<div class="midledetail" style=" float: left; width: 100%; display: inline-block; margin-left: 10px">
			<label>Paid To:</label> <span id="CustomerName" style="text-decoration: underline;"></span><br><br>
			<label>Paid Amount:</label> <span id="receivedamount"style="text-decoration: underline;"></span>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp<label>Amount:</label><span id="amount"style="text-decoration: underline;"></span><br><br>
...
<script type="text/javascript">
	...
	var ajax = new XMLHttpRequest();
	    var method = "Get";
	    var url = "PaidReceiptinfo.php?id="+id;
	    var asyn = true;
	    ...
	    ajax.onreadystatechange = function display()
	    {
	        if(this.readyState == 4 && this.status == 200)
	        {
	            ...
	            for (var i = 0; i<data.length ; i++)
	            {
	                ...
	                var am = numberToEnglish(PaidAmount,",");
	                var b = data[i].being;
	            }
	            document.getElementById("recno").innerHTML = ReceiptNo;
	            document.getElementById("CustomerName").innerHTML = vendorname;
	            document.getElementById("receivedamount").innerHTML = PaidAmount;
