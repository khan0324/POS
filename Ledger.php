...
<div class="wrapper">
	...
	<div class="Top"><!-- Top Class Contains Customer info and all things regarding company like Logo, phone no and address -->
		...
		<div class="Nameon companydetail" style="width: 100%; margin: 10px 0px 0px 20px;text-align: center;">
            <h1 style="font-size:50px; font-family: Georgia, serif; text-decoration: underline; text-decoration-color: #007bff; text-align: center; ">ITFAQ AUTO</h1>
...
<h4 class="T" style="width: auto;" ><span id="accountholder"></span></h4>
...
<script type="text/javascript">
    ...
    var method = "Get";
    var url = "DisplayCustomerLedger.php?name="+name;
    var asyn = true;
