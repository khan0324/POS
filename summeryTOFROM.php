 ...
 <div class="wrapper">
    <div class="container mt-5">
      <h4 class="T" ><span id="h-datefrom"></span>&nbspTO&nbsp<span id="h-dateto"></span></h4>
  ...
  document.getElementById("h-datefrom").innerHTML = datefrom;
    document.getElementById("h-dateto").innerHTML = dateto;
 
 var EPrice = 0;
      var ReceivedAmount = 0;
      var ajax = new XMLHttpRequest();
      var method = "Get";
      var url = "daygetdatatofrom.php?datefrom="+datefrom+"&dateto="+dateto;//Invoice == Report
      var asyn = true;
      ...
      var ajax = new XMLHttpRequest();
      var method = "Get";
      var url = "getsummerydatatofrom.php?datefrom="+datefrom+"&dateto="+dateto;
      var asyn = true;
      //Ajax open XML Request
      ajax.open(method,url,asyn);
      ajax.send();
